...
async def message_handler(msg: MessageType):
	...
	is_triggered = any([i for i in ["Марк", "marq", "@maxzens_bot"] if i in message_text.lower()])
	...
	# Рандомный шанс.
	#print('@')
	x1_100 = random.randint(1, 100)
	print(is_triggered, x1_100 )
	if x1_100 > (90 if is_triggered else 55): # шанс НЕ отвечать
		print('bye')
		return
